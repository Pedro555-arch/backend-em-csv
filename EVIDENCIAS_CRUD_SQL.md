...
## Identificação 
Nome: Pedro Henrique Ribeiro Pereira
Turma: 3°EM-B
Data: 19-05-2026
--- 
...
Trilha CRUD SQL - db_em - DBeaver 
cole aqui a saída do SELECT 
id|station_id|timestamp|temperature_c|humidity_pct|(Tudo está em branco)
--+----------+---------+-------------+------------+
``` 
...
INSERT: Adiciona novos dados/linhas a uma tabela. Cria um registro do zero.
UPDATE: Modifica dados que já existem em uma tabela. Altera os valores de colunas específicas em linhas já criadas.
DELETE: Remove registros (linhas) inteiros de uma tabela. O dado deixa de existir.